package com.fei_ke.common.kotterknife
...
public fun <V : View> BaseEpoxyHolder.bindView(id: Int): ReadOnlyProperty<BaseEpoxyHolder, V> = required(id, viewFinder)
...
private val BaseEpoxyHolder.viewFinder: BaseEpoxyHolder.(Int) -> View? get() = { itemView.findViewById(it) }
